...
deque<Vec8> Finite_stage_mission(){
    ...
    stage << 6, 0, 0, 0.75, 3.14, 0, 0, 5;
    waypoints.push_back(stage);
    stage << 6, -1, 1, 0.75, 3.14, 0, 0, 5;
    waypoints.push_back(stage);
    stage << 6, -1, -1, 0.75, 3.14, 0, 0, 5;
    waypoints.push_back(stage);
    stage << 6, 1, -1, 0.75, 3.14, 0, 0, 5;
...
//     waypoints.push_back(stage);
//     stage << 2, 1.5, 1.5, 1, 0, velocity_mission, velocity_angular, 0;   // state = 2; constant velocity trajectory.
//     waypoints.push_back(stage);
//     stage << 2,-1.5, 1.5, 1, 0, velocity_mission, velocity_angular, 0;
//     waypoints.push_back(stage);
//     stage << 2,-1.5,-1.5, 1, 0, velocity_mission, velocity_angular, 0;
//     waypoints.push_back(stage);
//     stage << 2, 1.5,-1.5, 1, 0, velocity_mission, velocity_angular, 0;
//     waypoints.push_back(stage);
//     stage << 4, 0, 0, 1, 0, velocity_mission, velocity_angular, 10;  // state = 4; constant velocity RTL but with altitude.
//     waypoints.push_back(stage);
//     stage << 5, 0, 0, -10, 0, velocity_mission, velocity_angular, 60;  // state = 5; land.
//     waypoints.push_back(stage);
//     cout << " Mission generated!" << " Stage count: " << waypoints.size() << endl;

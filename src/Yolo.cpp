...
/*uav local parameter*/
static geometry_msgs::PoseStamped YOLO_pose_realsense,Camera_pose_sub,UAV_pose_sub,UGV_pose_sub;
...
void datalogger(){ 
    ...
    // if(logger_time-logger_time_last > 0.01){
        ofstream save("/home/patty/realsense_ws/src/realsense_ws/logs/Yolo_raw.csv", ios::app);
...
int main(int argc, char **argv){
    ...
    remove("/home/patty/realsense_ws/src/realsense_ws/logs/Yolo_raw.csv");

...
nexttile
plot(yolo(:,1),yolo(:,2),'Color','k','LineWidth',1);hold on
title('Position Estimation','FontSize',15);
...
set(gca,'FontSize',14);
legend('Yolo','GroundTruth','KF','Aruco','FontSize',15);

nexttile
plot(yolo(:,1),yolo(:,3),'Color','k','LineWidth',1);hold on
...
nexttile
plot(yolo(:,1),yolo(:,4),'Color','k','LineWidth',1);hold on
